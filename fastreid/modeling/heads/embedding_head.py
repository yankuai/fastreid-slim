...
class EmbeddingHead(nn.Module):
    def __init__(self, cfg):
        ...
        if cfg.PRUNE.NEW_FEAT_DIM == True and len(cfg.PRUNE.CFG_CHANNEL)!=0:
            feat_dim = cfg.PRUNE.CFG_CHANNEL[-1]
    ...
    def forward(self, features, targets=None):
        ...
        # print('input shape:',global_feat.shape)
        # print('head model:',self.bottleneck)
